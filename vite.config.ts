    ...
    test: {
      ...
      coverage: {
        ...
        exclude: [
          ...
          "frontend/src/main.tsx", // React entry bootstrap
          "frontend/src/routeTree.gen.ts", // generated by tanstack router
          "frontend/src/routes/__root.tsx", // router shell
          "frontend/src/config/**", // build/runtime config + test setup
          "frontend/src/bootstrap/**", // shadow-DOM mount bootstrap
          "frontend/src/components/DevtoolsPortal.tsx", // dev-only devtools
        ],
      },
    },
  };
