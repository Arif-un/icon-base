...
describe('IconPlaceholder', () => {
  ...
  it('calls onBrowseIcon when Browse Icon is clicked', () => {
    ...
    render(
      <IconPlaceholder onBrowseIcon={onBrowseIcon} onMediaLibrary={vi.fn()} onCustomSvg={vi.fn()} />,
    )
  ...
  it('calls onMediaLibrary when Media Library is clicked', () => {
    ...
    render(
      <IconPlaceholder onBrowseIcon={vi.fn()} onMediaLibrary={onMediaLibrary} onCustomSvg={vi.fn()} />,
    )
